 ...
 */
export default function ThanksTemplate({ partnerName, partnerLogoSrc, heading, body, nav }: Props) {
  return (
    <>
          ...
          <div className={styles.cobrand}>
            ...
            {partnerName && (
              <>
                ...
                {partnerLogoSrc && (
                  <Image src={partnerLogoSrc} alt="" width={24} height={24} aria-hidden style={{ height: 24, width: 24, objectFit: 'contain' }} />
                )}
