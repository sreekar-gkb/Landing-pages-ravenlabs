...
export type CampaignContent = {
  ...
  /** Path under /public to a real partner logo image, e.g. "/partners/zoho.webp".
   *  Only set this once Section 8's compliance check has been satisfied for this specific
   *  partner — see the assets already vetted and available at public/partners/. If unset,
   *  the nav renders partnerName as text only, which is always the safe default. */
